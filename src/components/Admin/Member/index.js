...
const Member = () => {
  ...
  const [rows, setRows] = useState([
    ...
    {name: "Bùi Nguyễn Gia Huy", role: 'Admin', latestAccessTime: '3 tháng trước'},
    {name: "Nguyễn Hoàng Bảo Hùng", role: 'Agency', latestAccessTime: '1 ngày trước'},
    {name: "Công ty TNHH MTV Traveloki", role: 'Agency', latestAccessTime: '1 giờ 12 phút trước'},
    {name: "Nguyễn Xuân Mạnh", role: 'User', latestAccessTime: '36 phút trước'},
